...
public class AddTaskCommandTest extends ToLuistGuiTest {
    ...
    public void addTaskWithDeadline() {
        ...
        runCommandThenCheckForTasks(command1, new Task[] { task1 }, new Task[] {});
        ...
        runCommandThenCheckForTasks(command2, new Task[] { task1 }, new Task[] { task2 });
    ...
    public void addEvent() {
        ...
        runCommandThenCheckForTasks(command3, new Task[] { task1 }, new Task[] { task2, task3 });
    ...
    public void addMultipleTypeTask_shouldNotBeCreated() {
        ...
        runCommandThenCheckForTasks(command1, new Task[] {}, new Task[] { task1, task2, task3, task4 });
    }
    ...
    public void addTaskWithInvalidPriorityLevel_shouldNotBeCreated() {
        ...
        runCommandThenCheckForTasks(command, new Task[] {}, new Task[] { task1, task2 });
    ...
    public void addRecurringFloatingTask() {
        ...
        runCommandThenCheckForTasks(command, new Task[] { task1 }, new Task[] {});
    ...
    public void addRecurringTaskWithWrongParams_shouldThrowException() {
        ...
        command = ADD + taskDescription + REPEAT + recurFrequencyString + FROM + from + TO + to;
        runCommandThenCheckForResultMessage(command, "Recurring frequency must be either 'daily',"
                + "'weekly', 'monthly' or 'yearly'.");
    }
